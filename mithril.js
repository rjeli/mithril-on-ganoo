...
var _12 = function($window) {
	...
	function createNodes(parent, vnodes, start, end, hooks, nextSibling, ns) {
		...
		} catch (e) { console.log('CREATENODES ERR!!', e); }
	}
	...
	function updateNode(parent, old, vnode3, hooks, nextSibling, ns) {
		...
		if (oldTag === tag) {
			...
			print('checking shouldNotUpdate...');
			if (shouldNotUpdate(vnode3, old)) return
			print('SHOULD UPDATE!', oldTag, typeof oldTag);
	...
	function updateText(old, vnode3) {
		print('updating text', old.children.toString(), 'vs', vnode3.children.toString());
	...
	EventDict.prototype.handleEvent = function (ev) {
		...
		var result
		print("handler0:", typeof handler0);
	...
	return function(dom, vnodes, redraw) {
		...
		try {
			...
			print('UPDATENODES ERR!!!', e, e.stack)
		} finally {
